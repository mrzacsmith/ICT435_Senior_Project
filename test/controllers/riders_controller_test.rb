...
class RidersControllerTest < ActionController::TestCase
  ...
  test "should create rider" do
    assert_difference('Rider.count') do
      post :create, rider: { address: @rider.address, description: @rider.description, latitude: @rider.latitude, longitude: @rider.longitude, title: @rider.title }
    end
  ...
  test "should update rider" do
    patch :update, id: @rider, rider: { address: @rider.address, description: @rider.description, latitude: @rider.latitude, longitude: @rider.longitude, title: @rider.title }
    assert_redirected_to rider_path(assigns(:rider))
  end
